<template>
    ...
    <div v-for="post in posts" :key="post.id" class="container rounded bg-light mt-2 mb-3 shadow">
        ...
        <div class="row p-2">
            <div class=" d-flex justify-content-between align-items-start">
                <div class="d-flex justify-content-start align-items-start">
                    <router-link :to="'/profile/' + post.user_id" style="text-decoration: none;color: black;" class="d-flex ">
        ...
        <div id="post-image" class="row pt-0 p-2" style="height: 60vh;">
            <img style="height: 60vh;" :src="post.image" alt="">
        </div>
